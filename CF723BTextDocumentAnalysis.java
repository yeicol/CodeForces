...
/**
 * See <a href="http://codeforces.com/problemset/problem/723/B">Text Document
 * Analysis</a>
 *
 * @author Brian Yeicol Restrepo Tangarife
 */
public class CF723BTextDocumentAnalysis {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String s = in.next();
        String g = "\\([a-zA-z_]*\\)";
        String[] outsides = s.replaceAll(g, "_").split("_+");
        ...
        while (m.find()) {
            group = m.group();
            aux = group.replaceFirst("\\(_*", "");
            aux = aux.replaceFirst("_*\\)", "");
            if (aux.length() > 0) {
                words += aux.split("_+").length;
            }
        }
